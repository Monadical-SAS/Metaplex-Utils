...
import { AssetKey, StorageType } from "./helpers/storage-type";
...
type ProcessFileResult = {
    manifestDataItem: BundlrTransaction | null
};
...
async function processFiles({
                                ...
                                bundlr,
                                storageType,
                            }: ProcessFileArgs): Promise<ProcessFileResult> {
    let manifestDataItem: BundlrTransaction | null = null;
    const manifest = JSON.parse(fs.readFileSync(filePair.manifest).toString())
        ...
        const result = getBundleRange(
            ...
            const {
                ...
                async function processBundleFilePair(accP, filePair) {
                    ...
                    console.log('Processed File Pair', filePair.key);
            ...
            if (storageType === StorageType.ArweaveSol) {
                ...
                console.log('Uploading bundle via Bundlr... in multiple transactions');
